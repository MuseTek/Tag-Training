...
generator = data_generator('/home/dormuth/MuseTek/sound-classification/panotti/Preproc/Train/', load_frac = .01,batch_size = 20)
x, y, paths, class_names = next(generator)
pdb.set_trace()
